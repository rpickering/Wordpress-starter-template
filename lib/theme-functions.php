<?php
/**
 * theme theme functions definted in /lib/init.php
 *
 * @package theme
 */
...
function mb_scripts() {
	...
	wp_enqueue_script( 'theme-navigation', get_template_directory_uri() . '/assets/js/vendor/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'theme-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/vendor/skip-link-focus-fix.js', array(), '20130115', true );
